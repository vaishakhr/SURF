...
Run: cd python && PYTHONPATH=. python visualize_sensor.py
"""
...
def main():
    ...
    data_path = os.path.join(project_root, "data", "sensor1.dat")
    ...
    out_path = os.path.join(script_dir, f"surf_plot_sensor_{alpha}.png")
