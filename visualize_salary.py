...
Run from repo root: python visualize_salary.py  (or PYTHONPATH=. python visualize_salary.py)
"""
...
def main():
    ...
    data_path = os.path.join(repo_root, "data", "salary.dat")
    ...
    out_path = os.path.join(repo_root, f"surf_plot_salary_{alpha}.png")
